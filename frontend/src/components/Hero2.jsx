    ...
    <section className="relative w-full py-16 md:py-20 bg-green-600 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-base sm:text-lg md:text-xl text-green-50 leading-relaxed">
          Your support helps us restore degraded lands, revive water sources, and
          empower rural communities across Bundelkhand. Every contribution plants
          real, trackable trees with geo-tagged updates and impact reports.
        </p>
      </div>
    </section>
  );
