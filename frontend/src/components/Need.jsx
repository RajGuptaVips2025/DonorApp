...
const needCards = [
  ...
  },
  {
    ...
    description:
      "Thousands migrate every year in search of livelihood",
    image: "/Need4.jpg",
    bgColor: "bg-gray-50",
    textColor: "text-gray-900",
    descColor: "text-gray-600",
  ...
  },
  {
    ...
    description:
      "Loss of trees worsens climate stress and soil erosion",
    image: "/Need5.jpg",
    bgColor: "bg-gray-50",
    textColor: "text-gray-900",
    descColor: "text-gray-600",
...
const Need = () => {
  return (
    <section id="csr" className="py-16 bg-white font-sans overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 mb-14">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg max-w-4xl mx-auto leading-relaxed">
            Bundelkhand is one of India’s most climate-stressed regions. These
            are the urgent challenges we’re addressing through restoration and
        ...
        <div className="flex w-max animate-scroll hover:pause-animation">
          {needCards.map((card, index) => (
            ...
            >
              ...
              <p
                className={`text-sm leading-relaxed px-2 ${card.descColor}`}
              >
                {card.description}
              </p>
            </div>
